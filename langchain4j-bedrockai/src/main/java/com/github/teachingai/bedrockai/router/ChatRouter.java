...
public class ChatRouter {
    ...
    public static void register(Javalin app, AppConfig config) {
        // 创建聊天模型
        ChatLanguageModel chatModel = BedrockAnthropicMessageChatModel.builder()
        ...
        StreamingChatLanguageModel streamingChatModel = BedrockAnthropicStreamingChatModel.builder()
                .region(config.getRegion())
                .model(config.getChatModel())
                .temperature(config.getTemperature())
                .maxTokens(config.getMaxTokens())
