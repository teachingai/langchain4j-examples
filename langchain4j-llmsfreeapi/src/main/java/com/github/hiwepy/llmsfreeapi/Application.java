...
import com.github.hiwepy.llmsfreeapi.config.AppConfig;
import com.github.hiwepy.llmsfreeapi.router.ChatRouter;
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        app.start(port);
        log.info("Langchain4j LLMsFreeAPI Application started on port {}", port);
    }
