...
public class ChatRouter {
    ...
    public static void register(Javalin app, AppConfig config) {
        // 创建聊天模型
        ChatLanguageModel chatModel = MiniMaxChatModel.builder()
                .apiKey(config.getMinimaxApiKey())
                .groupId(config.getMinimaxGroupId())
                .modelName(config.getChatModel())
                .temperature(config.getTemperature())
                .build();

        StreamingChatLanguageModel streamingChatModel = MiniMaxStreamingChatModel.builder()
                .apiKey(config.getMinimaxApiKey())
                .groupId(config.getMinimaxGroupId())
                .modelName(config.getChatModel())
                .temperature(config.getTemperature())
