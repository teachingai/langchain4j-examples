...
public class Langchain4jOllamaApplication {

    private static final Logger log = LoggerFactory.getLogger(Langchain4jOllamaApplication.class);
    ...
    public static void main(String[] args) {
        ...
        app.start(port);
        log.info("Langchain4j Ollama Application started on port {}", port);
    }

    private static AppConfig loadConfig() {
        Properties props = new Properties();
        try (InputStream is = Langchain4jOllamaApplication.class.getClassLoader()
