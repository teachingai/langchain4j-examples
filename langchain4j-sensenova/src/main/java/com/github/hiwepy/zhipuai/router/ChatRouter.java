...
import com.github.hiwepy.zhipuai.config.AppConfig;
...
import dev.langchain4j.model.zhipuai.ZhipuAiStreamingChatModel;
...
public class ChatRouter {
    ...
    public static void register(Javalin app, AppConfig config) {
        // 创建聊天模型 - Sensenova使用ZhipuAI的接口
        ChatLanguageModel chatModel = ZhipuAiChatModel.builder()
                .apiKey(config.getSensenovaApiKey())
