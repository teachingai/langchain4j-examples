package com.github.teachingai.router;

import com.github.teachingai.config.AppConfig;
...
import dev.langchain4j.model.workersai.WorkersAiStreamingChatModel;
...
public class ChatRouter {
    ...
    public static void register(Javalin app, AppConfig config) {
        // 创建聊天模型
        ChatLanguageModel chatModel = WorkersAiChatModel.builder()
                .apiKey(config.getWorkersAiApiKey())
                .accountId(config.getWorkersAiAccountId())
                .modelId(config.getChatModel())
                .build();

        StreamingChatLanguageModel streamingChatModel = WorkersAiStreamingChatModel.builder()
                .apiKey(config.getWorkersAiApiKey())
                .accountId(config.getWorkersAiAccountId())
                .modelId(config.getChatModel())
                .build();
